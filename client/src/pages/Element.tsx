      ...
      >
        ...
        <div className="hidden lg:block absolute bottom-[100px] left-1/2 -translate-x-1/2 w-[calc(100%-48px)] lg:w-auto lg:max-w-[500px] xl:max-w-[592px]">
          <div className="relative">
            ...
            <div className="rounded-[12px] px-[20px] lg:px-[24px] xl:px-[30px] py-[12px] lg:py-[14px] w-full" style={{ backgroundColor: isDarkMode ? '#0C0D0F' : '#F5F5F7', border: `1px solid ${theme.border}` }}>
              ...
              <p className="font-['Inter'] italic text-[12px] lg:text-[13px] xl:text-[14px] leading-[1.3]" style={{ color: isDarkMode ? '#504E5D' : '#999999' }}>
