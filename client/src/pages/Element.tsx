      ...
      >
        ...
        <div className="hidden xl:block absolute bottom-[130px] left-1/2 -translate-x-1/2 max-w-[592px]">
          <div className="relative">
            ...
            <div className="rounded-[12px] px-[30px] py-[15px] w-[592px]" style={{ backgroundColor: isDarkMode ? '#0C0D0F' : '#F5F5F7', border: `1px solid ${theme.border}` }}>
              <p className="font-['Inter'] font-normal text-[18px] leading-[1.3] mb-2" style={{ color: theme.textSecondary }}>
                {testimonials[testimonialIndex]?.quote}
              </p>
              <p className="font-['Inter'] italic text-[14px] leading-[1.3]" style={{ color: isDarkMode ? '#504E5D' : '#999999' }}>
