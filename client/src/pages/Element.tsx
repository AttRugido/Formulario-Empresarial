      ...
      >
        ...
        <div className="absolute bottom-[100px] sm:bottom-[130px] left-1/2 -translate-x-1/2 w-[calc(100%-32px)] sm:w-auto max-w-[592px]">
          <div className="relative">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="34" viewBox="0 0 58 50" fill="none" className="absolute -left-[20px] sm:-left-[39px] top-[12px] sm:top-[21px] w-[40px] h-[34px] sm:w-[58px] sm:h-[50px]">
