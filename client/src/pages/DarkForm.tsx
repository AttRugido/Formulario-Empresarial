      ...
      >
        ...
        <div className="hidden lg:hidden tall:lg:block absolute bottom-[70px] left-1/2 -translate-x-1/2 lg:max-w-[460px] xl:max-w-[540px]">
          <div className="relative">
            ...
            <div className="rounded-[10px] px-[16px] lg:px-[20px] xl:px-[24px] py-[10px] lg:py-[12px] w-full" style={{ backgroundColor: '#0C0D0F', border: `1px solid ${theme.border}` }}>
              ...
              <p className="font-['Inter'] italic text-[11px] lg:text-[12px] xl:text-[13px] leading-[1.3]" style={{ color: '#504E5D' }}>
