      ...
      >
        ...
        <div className="hidden lg:block absolute bottom-[60px] left-1/2 -translate-x-1/2 w-[90%] lg:w-[85%] xl:w-auto xl:max-w-[540px]">
          <div className="relative">
            ...
            <div className="rounded-[10px] px-[12px] lg:px-[16px] xl:px-[20px] py-[8px] lg:py-[10px] w-full" style={{ backgroundColor: '#0C0D0F', border: `1px solid ${theme.border}` }}>
              ...
              <p className="font-['Inter'] italic text-[10px] lg:text-[11px] xl:text-[12px] leading-[1.25]" style={{ color: '#504E5D' }}>
