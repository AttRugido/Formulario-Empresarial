...
export const ThankYou3 = (): JSX.Element => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      (window as any).dataLayer.push({
        ...
        virtualPageURL: '/obrigado-3',
        virtualPageTitle: 'Obrigado Lead MQL100+ - Grupo Rugido',
        page_path: '/obrigado-3',
        page_title: 'Obrigado Lead MQL100+ - Grupo Rugido'
      });
      console.log("GTM dataLayer push: virtualPageview /obrigado-3 (MQL100+ lead)");
    }
  }, []);
